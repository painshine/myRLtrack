...
% scoring network
block = dagnn.Conv('size', [1 1 512 1], 'hasBias', true);
dummy_score_nets = {};
for i = 1 : opts.num_videos
    dmnet = dagnn.DagNN();
    ...
    dmnet.params(dmnet.getParamIndex('fc6_2f')).value = 0.01 * randn(1,1,512,1,'single');
    dmnet.params(dmnet.getParamIndex('fc6_2f')).learningRate = 10;
    dmnet.params(dmnet.getParamIndex('fc6_2b')).value = zeros(1, 1, 'single');
