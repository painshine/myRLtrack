...
%% main loop
    ...
    if frame > 1
        %% add demo test
        itterres1 = params.res1;
        tem_res1 = itterres1(frame,:);
        tem_wsize = [tem_res1(1,4), tem_res1(1,3)];
        tem_pos = [tem_res1(1,2), tem_res1(1,1)] + floor(tem_wsize/2);
        if motion_distance > 225
            pos = tem_pos;
        end
        %%
        ...
        motion_distance = (pos(1)-oldpos(1))^2+(pos(2)-oldpos(2))^2;
