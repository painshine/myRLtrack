...
function results = run_AutoTrack3(seq,rp,bS)
% added parameter for my test
sname = seq.sname;
subS = seq;
mat_name = [sname '_AutoTrack'];
addpath(genpath('.\iterres'));
addpath(genpath('.\feature\lookup_tables'));
load(mat_name);
seq = subS;
iterres1 = results{1}.res;
params.res1 = iterres1;
